...
class Cliente(models.Model):
    ...
    codcli = models.CharField(max_length=10, verbose_name="Código")
    nomecli = models.CharField(max_length=100, verbose_name="Nome")
    ...
    fonecli = models.CharField(max_length=20,verbose_name="Telefone")
